...
def part2(line):
    for num, denom in product(line, line):
        if num % denom == 0 and num != denom:
            return num // denom

if __name__ == "__main__":
    num_lines = [[int(i) for i in line.split()] for line in INPUT.split('\n')]
    print("Part 1: {}".format(sum(part1(line) for line in num_lines)))
    print("Part 2: {}".format(sum(part2(line) for line in num_lines)))
